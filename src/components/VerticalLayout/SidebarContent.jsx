...
const SidebarContent = (props) => {
  ...
  const activeMenu = useCallback(() => {
    ...
    for (let i = 0; i < items.length; ++i) {
      const str = items[i]['pathname']
      const pieces = str.split(/[\s/]+/)
      const last = pieces[pieces.length - 1]
      items[i]['pathname'] = "/" + last;
      // items[i]['pathname'] =  "Navin 125";
      ...
      if (pathName === items[i].pathname) {
        // console.log(pathName + " Chevvk path aememe")
      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li className="">
              <Link to="/dashboard-saas" className="">
            ...
            <li className="">
              <Link to="/#" className="has-arrow">
                ...
                <span>{props.t("Subscription Management")}</span>
              </Link>
              <ul className="sub-menu" aria-expanded="false">
                <li className="">
                  <Link to="/subscription-plans" className="">{props.t("Plans")}</Link>
                </li>
                <li className="">
                  <Link to="/pricing" className="">{props.t("Pricing")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li className="">
              ...
              <ul className="sub-menu" aria-expanded="false">
                ...
                <li className="">
                  <Link to="/account-Customers" className="">{props.t("Customers")}</Link>
                </li>

                <li className="d-none">
                  <Link to="/account-Prospects-new-account" className="">{props.t("Prospects")}</Link>
                </li>
                <li className="d-none">
                  <Link to="/account-Customers-new-account" className="">{props.t("Customers")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li className="">
                  <Link to="/security-Users" className="">{props.t("Users")}</Link>
                </li>

                <li className="d-none">
                  <Link to="/security-Users-add-users" className="">{props.t("Add suers")}</Link>
                </li>
              </ul>
            </li>
            ...
            {/* <li className="">
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li className="">
                  <Link to="/New-Account-Profile" className="">{props.t("Profile")}</Link>
                </li>
                <li className="">
                  <Link to="/new-account-subscription" className="">{props.t("Subscriptions")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li className="">
                  <Link to="/security-management-roles">{props.t("Roles")}</Link>
                </li>
                <li className="">
                  <Link to="/security-management-Users">{props.t("Users")}</Link>
                </li>

                <li className="d-none">
                  <Link to="/security-management-Users-add-users">{props.t("Add suers")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li className="">
                  <Link to="/property-properties" className="">{props.t("Properties ")}</Link>
                </li>
                <li className="">
                  <Link to="/property-management-units" className="">{props.t("Units")}</Link>
                </li>
                <li className="">
                  <Link to="/property-management-residents" className="">{props.t("Residents")}</Link>
                </li>
            ...
            <li>
              <Link to="/#" className="has-arrow ">
                <i className="bx bx-task"></i>
                <span>{props.t("People Hub")}</span>
              </Link>
              <ul className="sub-menu" aria-expanded="false">
                <li className=""> <Link to="/People-Owners" className="">{props.t("Owners")}</Link>  </li>
                <li className=""> <Link to="/People-Tenants" className="">{props.t("Tenants")}</Link>   </li>
                <li className=""> <Link to="/People-Prospects" className="">{props.t("Prospects")}</Link>   </li>
              </ul>
            </li> */}
            ...
            {/* <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/register-customer">{props.t("Register Customer")}</Link>
                </li>
                <li>
            ...
            {/* <li>
              ...
              <ul className="sub-menu" aria-expanded="false">
                <li>
                  <Link to="/create-bill">{props.t("Create Bill")}</Link>
                </li>
                <li>
                  <Link to="/bill-list">{props.t("Billing List")}</Link>
                </li>
              </ul>
            </li> */}
