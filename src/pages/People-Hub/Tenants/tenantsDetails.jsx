...
import {
    Row, Badge, InputGroup, Container, Col, Modal, Card, CardText, Nav, CardBody, Label, Input, NavItem, NavLink, Form, Table, TabContent, TabPane, Button, UncontrolledTooltip, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem
} from "reactstrap";
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    {/* Render Breadcrumbs */}
                    <Breadcrumbs title="People Hub" breadcrumbItem="Tenants" />
                </Container>
