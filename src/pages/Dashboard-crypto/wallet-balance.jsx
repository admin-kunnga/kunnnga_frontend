              ...
              <Col lg="4" sm="6" className="align-self-center">
                <div>
                  ...
                  <h5>
                    ...
                    <span className="text-muted fs-14">$ {Ethereumvalue ? Ethereumvalue['Dollar'] : ''}</span>
                  </h5>
                </div>
                ...
                <div className="mt-4 pt-2">
                  ...
                  <h5>
                    ...
                    <span className="text-muted fs-14">$ {Bitcoinvalue ? Bitcoinvalue['Dollar'] : ''}</span>
                  </h5>
                </div>
                ...
                <div className="mt-4 pt-2">
                  ...
                  <h5>
                    ...
                    <span className="text-muted fs-14">$ {Litecoinvalue ? Litecoinvalue['Dollar'] : ''}</span>
                  </h5>
                </div>
              </Col>
            </Row>
