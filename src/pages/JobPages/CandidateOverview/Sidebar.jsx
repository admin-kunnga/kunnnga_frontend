                        ...
                        <ul className="list-unstyled vstack gap-3 mb-0">
                            <li>
                                <div className="d-flex">
                                    <i className='bx bx-calendar fs-18 text-primary'></i>
                                    <div className="ms-3">
                            ...
                            <li>
                                <div className="d-flex">
                                    <i className='bx bx-money fs-18 text-primary'></i>
                                    <div className="ms-3">
                            ...
                            <li>
                                <div className="d-flex">
                                    <i className='bx bx-user fs-18 text-primary'></i>
                                    <div className="ms-3">
                            ...
                            <li>
                                <div className="d-flex">
                                    <i className='mdi mdi-book-education fs-18 text-primary'></i>
                                    <div className="ms-3">
                            ...
                            <li>
                                <div className="d-flex">
                                    <i className='mdi mdi-google-translate fs-18 text-primary'></i>
                                    <div className="ms-3">
