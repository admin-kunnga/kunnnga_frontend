                        ...
                        <ul className="verti-timeline list-unstyled">
                            <li className="event-list">
                                ...
                                <div className="d-flex">
                                    <div className="flex-grow-1">
                                        <div>
                                            <h6 className="fs-14 mb-1">BCA - Bachelor of Computer Applications</h6>
                            ...
                            <li className="event-list">
                                ...
                                <div className="d-flex">
                                    <div className="flex-grow-1">
                                        <div>
                                            <h6 className="fs-14 mb-1">MCA - Master of Computer Application</h6>
                            ...
                            <li className="event-list">
                                ...
                                <div className="d-flex">
                                    <div className="flex-grow-1">
                                        <div>
                                            <h6 className="fs-14 mb-1">Design Communication Visual</h6>
                            ...
                            <CardBody>
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 overflow-hidden">
                                        <h5 className="text-truncate fs-15"><Link to="#" className="text-dark">New admin Design</Link></h5>
                        ...
                        <Card>
                            <CardBody>
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 overflow-hidden">
                                        <h5 className="text-truncate fs-15"><Link to="#" className="text-dark">App Landing UI</Link></h5>
                        ...
                        <Card>
                            <CardBody>
                                <div className="d-flex">
                                    ...
                                    <div className="flex-grow-1 overflow-hidden">
                                        <h5 className="text-truncate fs-15"><Link to="#" className="text-dark">Skote Dashboard UI</Link></h5>
