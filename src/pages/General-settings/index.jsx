...
import {
    ...
    DropdownMenu, DropdownItem, Badge, Dropdown, FormGroup
} from "reactstrap"
        ...
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    ...
                    <Breadcrumbs title="" breadcrumbItem="Account Details" />
                    ...
                    <Row className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                        ...
                        <Modal size="lg" centered="true" isOpen={modal_xlarge} toggle={() => { tog_xlarge(); }}>
                                ...
                                <Row>
                                    <Col md="3" xl="2">
                                        <Nav pills className="flex-column">
                                            ...
                                            <NavItem>
                                                <NavLink style={{ cursor: "pointer" }} className={classnames({ active: verticalActiveTab === "4", })} onClick={() => { toggleVertical("4"); }}  >   Account Information
                                                </NavLink>
                                            </NavItem>
                                        </Nav>
                                    </Col>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col lg={6} className="mb-3">
                                                            <div className="form-floating">
                                                                <input type="number" className="form-control" id="floatingnameInput" value="78958" readOnly />
                                                ...
                                                <div>
                                                    <Form>
                                                        <Row>
                                                                ...
                                                                <div className="inner-repeater mb-3">
                                                                    {(rows1 || []).map((formRow, key) => (
                                                                        ...
                                                                        <Row className="mb-3" key={key}>
                                                                            ...
                                                                            <Col md="12" lg="6">
                                                                                <Row>
                                                                                    <Col xs="10" lg="10" className="mb-3">
                                                                                        <div className="form-floating">
                                                                                            <input type="text" className="form-control" id="floatingnameInput" placeholder="Enter Name" />
                                                                                            <label htmlFor="floatingnameInput"> Name  <span className="text-danger">*</span></label>
                                                                                        </div>
                                                                                    </Col>
                                                                                    <Col xs={2} lg={2} className="mb-3 ps-0">
                                                                                        <Button
                                                                                            color="primary"
                                                                                            className="p-0 btn-block inner w-100 h-100"
                                                                                            id="unknown-btn"
                                                                                            style={{ width: "100%" }}
                                                                                            onClick={e => {
                                                            ...
                                                            <Col className="ms-auto col-auto text-end">  <button className="btn btn-primary me-2 w-xs">Save </button>
                                                                <button className="btn btn-light border-primary w-xs">Cancel </button></Col>
                                                        </Row>
                                                    </Form>
                                                </div>
                                            </TabPane>
                        ...
                        <Modal size="xl" scrollable={true} centered="true" isOpen={modal_xlarge2} toggle={() => { tog_xlarge2(); }}>
                            <div className="modal-header">
                                ...
                                <button onClick={() => { setmodal_xlarge2(false); }} type="button" className="close" data-dismiss="modal" aria-label="Close" >
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div className="modal-body">
                        ...
                        <Modal size="lg" scrollable={true} centered="true" isOpen={modal_xlarge3} toggle={() => { tog_xlarge3(); }}>
                            <div className="modal-header">
                                <h5
                                    className="modal-title mt-0"
                                    id="myExtraLargeModalLabel">
                                ...
                                <button onClick={() => { setmodal_xlarge3(false); }} type="button" className="close" data-dismiss="modal" aria-label="Close" >
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div className="modal-body">
