...
const BlogDetails = () => {
    //meta title
    document.title="Blog Details | Kunnga";
  return (
    <React.Fragment>
                        ...
                        <div>
                          <div className="text-center">
                            <div className="mb-4">
                              <Link
                                to="#"
                                className="badge bg-light fs-12"
                              >
                            ...
                            <Row>
                              <Col sm={4}>
                                <div>
                                  ...
                                  <h5 className="fs-15">Project</h5>
                                </div>
                              </Col>
                              <Col sm={4}>
                                <div className="mt-4 mt-sm-0">
                                  <p className="text-muted mb-2">Date</p>
                                  <h5 className="fs-15">10 Apr, 2020</h5>
                                </div>
                              </Col>
                              <Col sm={4}>
                                <div className="mt-4 mt-sm-0">
                                  <p className="text-muted mb-2">Post by</p>
                                  <h5 className="fs-15">Gilbert Smith</h5>
                                </div>
                              </Col>
                            </Row>
                          </div>
