                        ...
                        <div className="position-relative mb-3">
                          ...
                          <div className="blog-play-icon">
                            <Link to="#" className="avatar-sm d-block mx-auto">
                              <span className="avatar-title rounded-circle fs-18">
                  ...
                  <Col xl={8}>
                    ...
                    <div className="mt-5">
                      <div className="d-flex flex-wrap">
                        ...
                        <div className="ms-auto">
                          <span className="badge badge-soft-success rounded-pill float-end ms-1 fs-12">
                            03
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="mt-5">
                      <div className="d-flex flex-wrap">
                        ...
                        <div className="ms-auto">
                          <span className="badge badge-soft-success badge-pill float-right ms-1 fs-12">
                            06
                          </span>
                        </div>
                      </div>
