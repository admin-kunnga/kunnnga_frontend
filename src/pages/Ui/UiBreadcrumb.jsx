...
function UiBreadcrumb(props) {
    //meta title
  document.title = "Breadcrumb | Kunnga";
    return (
        <React.Fragment>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 className="mb-sm-0 fs-18">Dashboard</h4>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="page-title-box d-block align-items-center justify-content-between">
                                        <h4 className="mb-1 fs-18">Dashboard</h4>
                                        <div className="page-title-right">
                                            <nav >
                                                <ol className="breadcrumb m-0">
                                                    <li className="breadcrumb-item"><Link to="/#">Dashboards</Link></li>
                        ...
                        <Col sm={12}>
                            <Card>
                                <CardBody>
                                    ...
                                    <div className="page-title-box d-block align-items-center justify-content-between">
                                        <h4 className="mb-1 fs-18 text-center">Dashboard</h4>
                                        <div className="page-title-right">
                                            <nav >
