...
const UiProgressbar = () => {
  ...
  //meta title
  document.title = "Progress Bars | Kunnga";
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <div >
                    <div className="mb-4">
                      <h5 className="fs-13">Progress sm</h5>
                      <Progress
                        value={25}
                        color="primary"
                    ...
                    <div className="mb-4">
                      <h5 className="fs-13">Progress md</h5>
                      <Progress
                        value={40}
                        color="success"
                    ...
                    <div className="mb-4">
                      <h5 className="fs-13">Progress lg</h5>
                      <Progress
                        value={50}
                        color="warning"
                    ...
                    <div>
                      <h5 className="fs-13">Progress xl</h5>
                      <Progress
                        value={70}
                        color="danger"
                    ...
                    <div className="custom-progess mb-5">
                      ...
                      <div className="avatar-xs progress-icon">
                        <span className="avatar-title rounded-circle border border-danger">
                          <i className="bx bxl-html5 text-danger fs-18"></i>
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="custom-progess mb-5">
                      ...
                      <div className="avatar-xs progress-icon">
                        <span className="avatar-title rounded-circle border border-primary">
                          <i className="bx bxl-css3 text-primary fs-18"></i>
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="custom-progess mb-5">
                      ...
                      <div className="avatar-xs progress-icon">
                        <span className="avatar-title rounded-circle border border-info">
                          <i className="bx bxl-jquery text-info fs-18"></i>
                        </span>
                      </div>
                    </div>
                  </div>
