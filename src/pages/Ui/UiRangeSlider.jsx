...
const UiRangeSlider = () => {
   ...
   //meta title
   document.title = "Range Slider | Kunnga";
              ...
              <Card>
                <CardBody>
                  ...
                  <Row>
                    <Col md={6}>
                      <div className="p-3">
                        <h5 className="fs-14 mb-3 mt-0">Default</h5>
                    ...
                    <Col md={6}>
                      <div className="p-3">
                        <h5 className="fs-14 mb-3 mt-0">Min-Max</h5>
                  ...
                  <Row>
                    <Col md={6}>
                      <div className="p-3">
                        <h5 className="fs-14 mb-3 mt-0">Prefix</h5>
                        <span className="float-left mt-4">0</span>{" "}
                        <span className="float-right  mt-4">100</span>
                        <Slider
                          min={0}
                    ...
                    <Col md={6}>
                      <div className="p-3">
                        <h5 className="fs-14 mb-3 mt-0">Postfixes</h5>
                        <span className="float-left mt-4">0</span>{" "}
                        <span className="float-right  mt-4">100</span>
                        <Slider
                          min={0}
                  ...
                  <Row>
                    <Col md={6}>
                      <div className="p-3">
                        <h5 className="fs-14 mb-3 mt-0">Step</h5>
                        <span className="float-left mt-4">0</span>{" "}
                        <span className="float-right  mt-4">100</span>
                        <Slider
                          value={step}
                  ...
                  <Row>
                    <Col md={6}>
                      <div className="p-3">
                        <h5 className="fs-14 mb-3 mt-0">Reverse</h5>
