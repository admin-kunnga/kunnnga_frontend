              ...
              <Card>
                ...
                <CardBody>
                  <blockquote className="card-blockquote mb-0">
                    ...
                    <footer className="blockquote-footer fs-12">
                      Someone famous in
                ...
                >
                  ...
                  >
                    ...
                    <Card>
                      <CardBody>
                        <blockquote className="blockquote fs-14 mb-0">
                          ...
                          <footer className="blockquote-footer mt-0 fs-12">
                    ...
                    <div className="card bg-primary text-white text-center p-3">
                      <blockquote className="card-blockquote fs-14 mb-0">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat.</p>
                        <footer className="blockquote-footer mt-0 text-white fs-12 mb-0">
                          Someone famous in <cite title="Source Title">Source Title</cite>
                        </footer>
                      </blockquote>
                    </div>
