...
const EcommerceProducts = (props) => {
  //meta title
  document.title = "Products | Kunnga";
            ...
            <Col lg="3">
              <Card>
                <CardBody>
                  ...
                  <div>
                    <h5 className="fs-14 mb-3">Clothes</h5>
                  ...
                  <div className="mt-4 pt-3">
                    <h5 className="fs-14 mb-3">Price</h5>
                    <br />
                  ...
                  <div className="mt-4 pt-3">
                    <h5 className="fs-14 mb-3">Discount</h5>
                  ...
                  <div className="mt-4 pt-3">
                    <h5 className="fs-14 mb-3">Customer Rating</h5>
                    <div>
