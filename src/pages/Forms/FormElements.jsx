...
const FormElements = () => {
  ...
  //meta title
  document.title = "Form Elements | Kunnga"
              ...
              <Card>
                <CardBody>
                  ...
                  <Row>
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="fs-14 mb-4">Form Radios</h5>
                        <div className="form-check mb-3">
                          <input
                            className="form-check-input"
                            type="radio"
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="fs-14 mb-4">Form Radios Right</h5>
                        <div>
                          <div className="form-check form-check-right mb-3">
                            <input
                              type="radio"
              ...
              <Card>
                <CardBody>
                  ...
                  <Row>
                    <Col sm={6}>
                      <div>
                        <h5 className="fs-14 mb-3">Switch examples</h5>
                        <div
                    ...
                    <Col sm={6}>
                      <div className="mt-4 mt-lg-0">
                        <h5 className="fs-14 mb-3">Switch sizes</h5>
            ...
            <Col lg={12}>
              <Card>
                <CardBody>
                  ...
                  <div>
                    <h5 className="fs-14"><i className="mdi mdi-arrow-right text-primary"></i> Default file input</h5>
                    <div className="row">
                      <Col sm={6}>
                  ...
                  <div className="mt-4 pt-2">
                    <h5 className="fs-14 mb-0"><i className="mdi mdi-arrow-right text-primary"></i> Custom file input</h5>
                  </div>
