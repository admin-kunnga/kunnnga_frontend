      ...
      <Card className="filemanager-sidebar ms-lg-2">
        <CardBody>
          <div className="text-center">
            <h5 className="fs-15 mb-4">Storage</h5>
            <div>
              <ReactApexChart
                options={options}
                series={series}
                ...
                <div className="p-2">
                  <div className="d-flex">
                    ...
                    <div className="overflow-hidden me-auto">
                      <h5 className="fs-13 text-truncate mb-1">
                        Images
                      </h5>
              ...
              <Link to="#" className="text-body">
                <div className="p-2">
                  <div className="d-flex">
                    ...
                    <div className="overflow-hidden me-auto">
                      <h5 className="fs-13 text-truncate mb-1">Video</h5>
              ...
              <Link to="#" className="text-body">
                <div className="p-2">
                  <div className="d-flex">
                    ...
                    <div className="overflow-hidden me-auto">
                      <h5 className="fs-13 text-truncate mb-1">Music</h5>
