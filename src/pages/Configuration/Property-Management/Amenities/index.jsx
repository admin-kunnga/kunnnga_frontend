...
import {
    ...
    DropdownMenu, DropdownItem, Dropdown, CardTitle, Collapse, UncontrolledTooltip, Modal, Label
} from "reactstrap"
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    {/* Render Breadcrumbs */}
                    {/* <Breadcrumbs title="Property Management Settings" breadcrumbItem="Amenities" /> */}
                                ...
                                <div className="accordion-item mb-5">
                                    ...
                                    <Modal
                                        ...
                                        <div className="modal-body">
                                            ...
                                            <div className="mb-3">
                                                <label htmlFor="exampleInputEmail1" className="form-label"> Amenity Name</label>
                                                <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                                            </div>

                                            <div className="mb-3">
                                                <label htmlFor="floatingSelectGrid">Amenity Icons</label>
                                                <Select
                                            ...
                                            <div className="mb-3">
                                                <label htmlFor="exampleInputEmail1" className="form-label"> Amenity Description </label>
                                                <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
                                            </div>
