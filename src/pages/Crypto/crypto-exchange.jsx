...
const CryptoExchange = props => {
  ...
  //meta title
  document.title="Exchange | Kunnga";
                    ...
                    <Col xl="3" sm="4">
                      <div className="d-flex">
                        <div className="avatar-sm me-3">
                          <span className="avatar-title rounded-circle bg-warning bg-soft text-warning fs-22">
                  ...
                  <div className="mt-4">
                    ...
                    <TabContent activeTab={activeTab} className="mt-4">
                      <TabPane tabId="1" id="buy-tab">
                        <h5 className="fs-14 mb-4">Buy Coin</h5>
                      ...
                      <TabPane tabId="2" id="sell-tab">
                        <h5 className="fs-14 mb-4">Sell Coin</h5>
                      ...
                      {notofications.map((notification, key) => (
                        <li key={key} className="event-list">
                          <div className="event-timeline-dot">
                            <i className="bx bx-right-arrow-circle fs-18" />
                          </div>
                          <div className="d-flex">
                            <div className="me-3">
                              <h5 className="fs-14">
