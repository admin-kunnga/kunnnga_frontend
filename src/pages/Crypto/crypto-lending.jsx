                ...
                <CardBody className="border-bottom">
                  ...
                  >
                    <DropdownToggle tag="a" className="text-muted">
                      <i className="mdi mdi-dots-horizontal fs-18" />
                    </DropdownToggle>
                    <DropdownMenu>
                    ...
                    <ul className="verti-timeline list-unstyled">
                      <li className="event-list">
                        ...
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1">
                            <div>
                              <h5 className="fs-14">Register account</h5>
                      ...
                      <li className="event-list">
                        ...
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1">
                            <div>
                              <h5 className="fs-14">Select Deposit</h5>
                              <p className="text-muted">
                      ...
                      <li className="event-list">
                        ...
                        <div className="d-flex">
                          ...
                          <div className="flex-grow-1">
                            <div>
                              <h5 className="fs-14">Get Earnings</h5>
                              <p className="text-muted">
                                New common language will be more simple and
                                regular than the existing.
                              </p>
                  ...
                  <Row>
                      ...
                      <div className="border p-3 rounded mt-4">
                        <div className="d-flex align-items-center mb-3">
                          <div className="avatar-xs me-3">
                            <span className="avatar-title rounded-circle bg-warning bg-soft text-warning fs-18">
                              <i className="mdi mdi-bitcoin" />
                            </span>
                          </div>
                          <h5 className="fs-14 mb-0">Bitcoin</h5>
                        </div>
                    ...
                    <Col lg="4">
                      <div className="border p-3 rounded mt-4">
                        <div className="d-flex align-items-center mb-3">
                          <div className="avatar-xs me-3">
                            <span className="avatar-title rounded-circle bg-primary bg-soft text-primary fs-18">
                              <i className="mdi mdi-ethereum" />
                            </span>
                          </div>
                          <h5 className="fs-14 mb-0">Ethereum</h5>
                        </div>
                    ...
                    <Col lg="4">
                      <div className="border p-3 rounded mt-4">
                        <div className="d-flex align-items-center mb-3">
                          <div className="avatar-xs me-3">
                            <span className="avatar-title rounded-circle bg-info bg-soft text-info fs-18">
                              <i className="mdi mdi-litecoin" />
                            </span>
                          </div>
                          <h5 className="fs-14 mb-0">Litecoin</h5>
                        </div>
