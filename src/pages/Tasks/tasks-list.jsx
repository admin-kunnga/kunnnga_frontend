...
const TasksList = () => {
  //meta title
  document.title = "Task List | Kunnga";
                    ...
                    <table className="table table-nowrap align-middle mb-0">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <h5 className="text-truncate fs-14 m-0">
                          ...
                          <td>
                            <div className="text-center">
                              <span className="badge rounded-pill badge-soft-secondary fs-11">
                                Waiting
                              </span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="text-center">
                              <span className="badge rounded-pill badge-soft-primary fs-11">
                                Approved
                              </span>
                            </div>
                          </td>
                    ...
                    <table className="table table-nowrap align-middle mb-0">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div className="text-center">
                              <span className="badge rounded-pill badge-soft-success fs-11">
                                Complete
                              </span>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="text-center">
                              <span className="badge rounded-pill badge-soft-warning fs-11">
                                Pending
                              </span>
                            </div>
                          </td>
