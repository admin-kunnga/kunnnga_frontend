...
function PropertyProperties() {
  ...
  const routeChange = () => {
    let path = `/property-management-residents-details`;
    navigate(path);
  }
    ...
    () => [
      {
        ...
        Cell: (cellProps) => {
          return <>
            <Link to="/property-management-residents-details">
    ...
    <React.Fragment>
      ...
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="Property Management" breadcrumbItem="Residents" />
                ...
                <CardBody className="pb-0">
                  <Row>
                    ...
                    <Col className="text-end">
                      ...
                      <Link to="/new-property-management-residents">
                  ...
                  <Table className="project-list-table table-nowrap align-middle table-borderless">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td onClick={routeChange} className="cursor-pointer">
                          Building One
                          {/* <h5 className="text-truncate fs-14">
                                <Link to="/property-properties-details"
                                  className="text-dark"
                                >
                                  Building One
                                </Link>
                        ...
                        <td onClick={routeChange} className="cursor-pointer"> 500 </td>
